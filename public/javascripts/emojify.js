  ...
  var emojify = (function () {
    ...
    return {
      ...
      run: function () {
        ...
        var selected_sets = [];
        if (this.defaultConfig.people_enabled) selected_sets.push(people.slice());
        if (this.defaultConfig.nature_enabled) selected_sets.push(nature.slice());
      ...
      //  if (this.defaultConfig.emoticons_enabled) selected_sets.push(emoticons.slice());
        ...
        for (var index = 0; index < selected_sets.length; index++) {
          ...
          var r;
          //for(var r = 0; r < selected_sets[index].length; r++ ) {
      ...
      runOverElement: function (element) {
        // Create array of selected icon sets
        var selected_sets = [];
        if (this.defaultConfig.people_enabled) selected_sets.push(people.slice());
        if (this.defaultConfig.nature_enabled) selected_sets.push(nature.slice());
       ...
       // if (this.defaultConfig.emoticons_enabled) selected_sets.push(emoticons.slice());
        ...
        for (var index = 0; index < selected_sets.length; index++) {
          ...
          while (r = selected_sets[index].shift()) {
            // Find and replace matches with <div> tags
            findText(element, r[0], function (node, match) {
              var wrap = document.createElement(this.emojify.defaultConfig.emojify_tag_type);
              wrap.setAttribute('class', r[1]);
              // wrap.setAttribute('alt', ':' + r[1].replace(/emojify /g, '') + ':');
              //wrap.setAttribute('title', ':' + r[1].replace(/emojify /g, '') + ':');
